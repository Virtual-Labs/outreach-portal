		...
		<div class="row-fluid">
			...
			<div class="metro-nav">
				...
				<div class="metro-nav-block nav-olive">
					<a data-original-title="" href="#"> <i class="icon-tags"></i>
					<div class="info">
						12
					</div>
					<div class="status">
				...
				<div class="metro-nav-block nav-block-yellow">
					<a data-original-title="" href="#"> <i class="icon-comments-alt"></i>
					<div class="info">
						21
					</div>
					<div class="status">
				...
				<div class="metro-nav-block nav-block-green">
					<a data-original-title="" href="#"> <i class="icon-eye-open"></i>
					<div class="info">
						2
					</div>
					<div class="status">
