			...
			<div class="container">
				<div class="row">
					<div id="content" class="col-lg-12">
									...
									<div class="col-md-9">
										<div class="box border dark gray">
											...
											<span id="error" class='error'></span>
												<form class="form-horizontal" method="post" name="addworkshopmaterial" id="addworkshopmarerial"   onsubmit="return Checkfiles();" action="<?php echo site_url('admin/workshop_material_add');?>" role="form" enctype="multipart/form-data">
						...
						<!-- Save -->	
						<p class="btn-toolbar">							
							<button class="btn btn-success" style="color: #fff;background-color: #309CD1;padding: 9px;border-radius: 8px;">Create</button></form>
					<a href="<?php echo base_url('admin/workshop_material')?>">	<button class="btn" style="border-color: #7c7c7c;">Cancel</button>	</a>
						</p>
						<!-- /Save -->												
						</form>
					</div><!-- /CONTENT-->
