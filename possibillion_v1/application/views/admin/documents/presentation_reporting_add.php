	<div id="main-content">
			<div class="container">
				<div class="row">
									...
									<div class="col-md-9">
										<div class="box border dark gray">
											...
											<span id="error" class='error'></span>
												<form class="form-horizontal" method="post" name="presentation" id="presentation" action="<?php echo site_url('admin/presentation_reporting_add');?>"   onsubmit="return Checkfiles();" role="form" enctype="multipart/form-data">
					...
					<a href="<?php echo base_url('admin/presentation_reporting')?>">	<button class="btn" style="border-color: #7c7c7c;">Cancel</button>	</a>
						</p>
						<!-- /Save -->												
						</form>
					</div><!-- /CONTENT-->
