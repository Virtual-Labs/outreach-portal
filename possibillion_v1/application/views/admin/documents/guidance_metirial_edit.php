<div id="main-content">
			<div class="container">
				<div class="row">
											...
											<span id="error" class='error'></span>
												<form class="form-horizontal" method="post" name="editguidance" id="editguidance" action="<?php echo site_url('admin/guidance_metirial_edit/'.base64_encode($guidance_metirial_data[0]['id']));?>" role="form"   onsubmit="return Checkfiles();" enctype="multipart/form-data">
												  ...
												  <div class="form-group">
													...
													<img src="<?php echo base_url() . "assests/uploads/guidancemetirial/" . $guidance_metirial_data[0]['path']; ?>" width="130" >
													</div>
												  </div>
											</div>
										</div>
					...
					<a href="<?php echo base_url('admin/guidance_metirial')?>">	<button class="btn" style="border: 1px solid #000;">Cancel</button>	</a>
						</p>
						<!-- /Save -->												
						</form>
					</div><!-- /CONTENT-->
