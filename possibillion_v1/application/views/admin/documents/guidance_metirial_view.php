							...
							<div class="col-md-12">
								...
								<div class="box solid gray">
									...
									<div class="tools hidden-xs">
											<a href="<?php echo site_url('admin/guidance_metirial_add'); ?>" style="color: #fff;background-color: #309CD1;padding: 2px;border-radius: 8px;">Add New Guidance & Material</a>
										</div>
									</div>
									<div class="box-body">
